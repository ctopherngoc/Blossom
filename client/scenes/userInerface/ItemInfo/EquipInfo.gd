	...
	if valid:
		...
		if stats.type in ["1h_sword", "bow", "gun", "1h_blunt", "2h_blunt", "1h_axe", "2h_axe", "dagger", "wand", "staff"]:
			...
			if stats.attack > GameData.equipmentTable[stats.id].attack:
				attack.get_node("StatLabel").set("theme_override_colors/font_color", Color("00ff15"))
				attack.get_node("StatNumber").set("theme_override_colors/font_color", Color("00ff15"))
			elif stats.attack < GameData.equipmentTable[stats.id].attack:
				attack.get_node("StatLabel").set("theme_override_colors/font_color", Color("db0000"))
				attack.get_node("StatNumber").set("theme_override_colors/font_color", Color("db0000"))
			extraStats.add_child(attack)
			
			if stats.magic != 0:
				var magic = itemStat.instantiate()
				...
				if stats.magic > GameData.equipmentTable[stats.id].magic:
					magic.get_node("StatLabel").set("theme_override_colors/font_color", Color("00ff15"))
					magic.get_node("StatNumber").set("theme_override_colors/font_color", Color("00ff15"))
				elif stats.magic < GameData.equipmentTable[stats.id].magic:
					magic.get_node("StatLabel").set("theme_override_colors/font_color", Color("db0000"))
					magic.get_node("StatNumber").set("theme_override_colors/font_color", Color("db0000"))
				extraStats.add_child(magic)
		
		if stats.strength != 0:
				var strength = itemStat.instantiate()
				...
				if stats.strength > GameData.equipmentTable[stats.id].strength:
					strength.get_node("StatLabel").set("theme_override_colors/font_color", Color("00ff15"))
					strength.get_node("StatNumber").set("theme_override_colors/font_color", Color("00ff15"))
				elif stats.strength < GameData.equipmentTable[stats.id].strength:
					strength.get_node("StatLabel").set("theme_override_colors/font_color", Color("db0000"))
					strength.get_node("StatNumber").set("theme_override_colors/font_color", Color("db0000"))
				extraStats.add_child(strength)
		
		if stats.dexterity != 0:
				var dexterity = itemStat.instantiate()
				...
				if stats.dexterity > GameData.equipmentTable[stats.id].dexterity:
					dexterity.get_node("StatLabel").set("theme_override_colors/font_color", Color("00ff15"))
					dexterity.get_node("StatNumber").set("theme_override_colors/font_color", Color("00ff15"))
				elif stats.dexterity < GameData.equipmentTable[stats.id].dexterity:
					dexterity.get_node("StatLabel").set("theme_override_colors/font_color", Color("db0000"))
					dexterity.get_node("StatNumber").set("theme_override_colors/font_color", Color("db0000"))
				extraStats.add_child(dexterity)
		
		if stats.wisdom != 0:
				var wisdom = itemStat.instantiate()
				...
				if stats.wisdom > GameData.equipmentTable[stats.id].wisdom:
					wisdom.get_node("StatLabel").set("theme_override_colors/font_color", Color("00ff15"))
					wisdom.get_node("StatNumber").set("theme_override_colors/font_color", Color("00ff15"))
				elif stats.wisdom < GameData.equipmentTable[stats.id].wisdom:
					wisdom.get_node("StatLabel").set("theme_override_colors/font_color", Color("db0000"))
					wisdom.get_node("StatNumber").set("theme_override_colors/font_color", Color("db0000"))
				extraStats.add_child(wisdom)
		
		if stats.luck != 0:
				var luck = itemStat.instantiate()
				...
				if stats.luck > GameData.equipmentTable[stats.id].luck:
					luck.get_node("StatLabel").set("theme_override_colors/font_color", Color("00ff15"))
					luck.get_node("StatNumber").set("theme_override_colors/font_color", Color("00ff15"))
				elif stats.luck < GameData.equipmentTable[stats.id].luck:
					luck.get_node("StatLabel").set("theme_override_colors/font_color", Color("db0000"))
					luck.get_node("StatNumber").set("theme_override_colors/font_color", Color("db0000"))
				extraStats.add_child(luck)
		
		if stats.critRate != 0:
				var critRate = itemStat.instantiate()
				...
				if stats.critRate > GameData.equipmentTable[stats.id].critRate:
					critRate.get_node("StatLabel").set("theme_override_colors/font_color", Color("00ff15"))
					critRate.get_node("StatNumber").set("theme_override_colors/font_color", Color("00ff15"))
				elif stats.critRate < GameData.equipmentTable[stats.id].critRate:
					critRate.get_node("StatLabel").set("theme_override_colors/font_color", Color("db0000"))
					critRate.get_node("StatNumber").set("theme_override_colors/font_color", Color("db0000"))
				extraStats.add_child(critRate)
				
		if stats.bossPercent != 0:
				var bossPercent = itemStat.instantiate()
				...
				if stats.bossPercent > GameData.equipmentTable[stats.id].bossPercent:
					bossPercent.get_node("StatLabel").set("theme_override_colors/font_color", Color("00ff15"))
					bossPercent.get_node("StatNumber").set("theme_override_colors/font_color", Color("00ff15"))
				elif stats.bossPercent < GameData.equipmentTable[stats.id].bossPercent:
					bossPercent.get_node("StatLabel").set("theme_override_colors/font_color", Color("db0000"))
					bossPercent.get_node("StatNumber").set("theme_override_colors/font_color", Color("db0000"))
				extraStats.add_child(bossPercent)
		
		if stats.damagePercent != 0:
				var damagePercent = itemStat.instantiate()
				...
				if stats.damagePercent > GameData.equipmentTable[stats.id].damagePercent:
					damagePercent.get_node("StatLabel").set("theme_override_colors/font_color", Color("00ff15"))
					damagePercent.get_node("StatNumber").set("theme_override_colors/font_color", Color("00ff15"))
				elif stats.damagePercent < GameData.equipmentTable[stats.id].damagePercent:
					damagePercent.get_node("StatLabel").set("theme_override_colors/font_color", Color("db0000"))
					damagePercent.get_node("StatNumber").set("theme_override_colors/font_color", Color("db0000"))
				extraStats.add_child(damagePercent)
				
		if stats.accuracy != 0:
				var accuracy = itemStat.instantiate()
				...
				if stats.accuracy > GameData.equipmentTable[stats.id].accuracy:
					accuracy.get_node("StatLabel").set("theme_override_colors/font_color", Color("00ff15"))
					accuracy.get_node("StatNumber").set("theme_override_colors/font_color", Color("00ff15"))
				elif stats.accuracy < GameData.equipmentTable[stats.id].accuracy:
					accuracy.get_node("StatLabel").set("theme_override_colors/font_color", Color("db0000"))
					accuracy.get_node("StatNumber").set("theme_override_colors/font_color", Color("db0000"))
				extraStats.add_child(accuracy)
		
		if stats.maxHealth != 0:
				var maxHealth = itemStat.instantiate()
				...
				if stats.maxHealth > GameData.equipmentTable[stats.id].maxHealth:
					maxHealth.get_node("StatLabel").set("theme_override_colors/font_color", Color("00ff15"))
					maxHealth.get_node("StatNumber").set("theme_override_colors/font_color", Color("00ff15"))
				elif stats.maxHealth < GameData.equipmentTable[stats.id].maxHealth:
					maxHealth.get_node("StatLabel").set("theme_override_colors/font_color", Color("db0000"))
					maxHealth.get_node("StatNumber").set("theme_override_colors/font_color", Color("db0000"))
				extraStats.add_child(maxHealth)
		
		if stats.maxMana != 0:
				var maxMana = itemStat.instantiate()
				...
				if stats.maxMana > GameData.equipmentTable[stats.id].maxMana:
					maxMana.get_node("StatLabel").set("theme_override_colors/font_color", Color("00ff15"))
					maxMana.get_node("StatNumber").set("theme_override_colors/font_color", Color("00ff15"))
				elif stats.maxMana < GameData.equipmentTable[stats.id].maxMana:
					maxMana.get_node("StatLabel").set("theme_override_colors/font_color", Color("db0000"))
					maxMana.get_node("StatNumber").set("theme_override_colors/font_color", Color("db0000"))
				extraStats.add_child(maxMana)
				
		if stats.defense != 0:
				var defense = itemStat.instantiate()
				...
				if stats.defense > GameData.equipmentTable[stats.id].defense:
					defense.get_node("StatLabel").set("theme_override_colors/font_color", Color("00ff15"))
					defense.get_node("StatNumber").set("theme_override_colors/font_color", Color("00ff15"))
				elif stats.defense < GameData.equipmentTable[stats.id].defense:
					defense.get_node("StatLabel").set("theme_override_colors/font_color", Color("db0000"))
					defense.get_node("StatNumber").set("theme_override_colors/font_color", Color("db0000"))
				extraStats.add_child(defense)
		
		if stats.magicDefense != 0:
				var magicDefense = itemStat.instantiate()
				...
				if stats.magicDefense > GameData.equipmentTable[stats.id].magicDefense:
					magicDefense.get_node("StatLabel").set("theme_override_colors/font_color", Color("00ff15"))
					magicDefense.get_node("StatNumber").set("theme_override_colors/font_color", Color("00ff15"))
				elif stats.magicDefense < GameData.equipmentTable[stats.id].magicDefense:
					magicDefense.get_node("StatLabel").set("theme_override_colors/font_color", Color("db0000"))
					magicDefense.get_node("StatNumber").set("theme_override_colors/font_color", Color("db0000"))
				extraStats.add_child(magicDefense)
		
		if stats.avoidability != 0:
				var avoidability = itemStat.instantiate()
				...
				if stats.avoidability > GameData.equipmentTable[stats.id].avoidability:
					avoidability.get_node("StatLabel").text.set("theme_override_colors/font_color", Color("00ff15"))
					avoidability.get_node("StatNumber").text.set("theme_override_colors/font_color", Color("00ff15"))
				elif stats.avoidability < GameData.equipmentTable[stats.id].avoidability:
					avoidability.get_node("StatLabel").text.set("theme_override_colors/font_color", Color("db0000"))
					avoidability.get_node("StatNumber").text.set("theme_override_colors/font_color", Color("db0000"))
				extraStats.add_child(avoidability)
		
		if stats.movementSpeed != 0:
				var movementSpeed = itemStat.instantiate()
				...
				if stats.movementSpeed > GameData.equipmentTable[stats.id].movementSpeed:
					movementSpeed.get_node("StatLabel").text.set("theme_override_colors/font_color", Color("00ff15"))
					movementSpeed.get_node("StatNumber").text.set("theme_override_colors/font_color", Color("00ff15"))
				elif stats.movementSpeed < GameData.equipmentTable[stats.id].movementSpeed:
					movementSpeed.get_node("StatLabel").text.set("theme_override_colors/font_color", Color("db0000"))
					movementSpeed.get_node("StatNumber").text.set("theme_override_colors/font_color", Color("db0000"))
				extraStats.add_child(movementSpeed)
				
		if stats.jumpSpeed != 0:
				var jumpSpeed = itemStat.instantiate()
				...
				if stats.jumpSpeed > GameData.equipmentTable[stats.id].jumpSpeed:
					jumpSpeed.get_node("StatLabel").text.set("theme_override_colors/font_color", Color("00ff15"))
					jumpSpeed.get_node("StatNumber").text.set("theme_override_colors/font_color", Color("00ff15"))
				elif stats.jumpSpeed < GameData.equipmentTable[stats.id].jumpSpeed:
					jumpSpeed.get_node("StatLabel").text.set("theme_override_colors/font_color", Color("db0000"))
					jumpSpeed.get_node("StatNumber").text.set("theme_override_colors/font_color", Color("db0000"))
				extraStats.add_child(jumpSpeed)
				
		if stats.slot != null:
			var scroll_slot = itemStat.instantiate()
